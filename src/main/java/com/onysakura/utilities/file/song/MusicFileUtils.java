...
public class MusicFileUtils {
    private static final CustomLogger.Log LOG = CustomLogger.getLogger(MusicFileUtils.class);

    public static void main(String[] args) {

    }

    public static void findDuplicateFiles(String[] args) throws Exception {
        final String FINAL_PATH = "/Files/MusicF";
        final String DEL_PATH = "/Files/MusicDel";
        final String[] DIR_PATH = new String[]{
                "/Files/Music",
                "/Files/Music2",
        };
